...
public class UserRepository : IUserRepository
{
    ...
    public async Task<PagedList<MemberDto>> GetMembersAsync(UserParams userParams)
    {
        ...
        query = query.Where(u => u.UserName != userParams.CurrentUsername);//this excludes currently logged in user from results
        query = query.Where(u => u.Gender == userParams.Gender); //to comment for gender all
